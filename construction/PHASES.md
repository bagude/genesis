...
|-------|---------------------------------------|------------------------------------------------------------------------|-------------|
| -1    | Construction algebra                  | Verifier enforces proposal/grounding law over the construction ledger   | REALIZED    |
| 0     | Genesis / contracts                   | Every later operator has a declared domain and codomain; meta-ontology frozen | PENDING |
